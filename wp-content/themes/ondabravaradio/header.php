...
<header class="header">
			...
			<div class="header-social">
				 <a href="http://romanticaestereo.com/" class="icon-romantica" title="Romantica Estereo"><img src="<?php echo get_template_directory_uri(); ?>/img/romantica-icon-white.png" alt="Romantica Estereo"></a>
